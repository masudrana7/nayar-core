...
<div class="rt-testimonial-slider rt-testimonial-<?php echo esc_attr( $layout ) ?>">
    <div class="rt-swiper-vertical-slider <?php echo esc_attr( $arrow_hover_visibility ) ?>" data-xld ="<?php echo esc_attr( $swiper_data );?>">
                                    ...
                                    <div class="rt-rating">
                                        <ul class="item-rating">
					                        <?php for ( $i=0; $i <=4 ; $i++ ) {
						                        ...
						                        echo '<li class="has-rating"><i class="icon-rt-star ' . esc_attr( $full ) . '"></i></li>';
					                        } ?>
                                        </ul>
                                    </div>
		                        <?php } ?>
	                        <?php } ?>
                            <div class="rt-toptitle">
                                <?php echo esc_html( $item['toptitle'] ); ?>
                            </div>
