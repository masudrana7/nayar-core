...
if( $project_thumbnail_size ) {
	...
	$thumb_size = 'nayar-size5';
}

$query = new WP_Query( $args );

?>
<div class="rt-project-default rt-project-multi-layout-4 project-grid-<?php echo esc_attr( $layout );?>">
	...
	<?php } if ( $display_scrollbar == 'yes' ) { ?>
        <div class="swiper-scrollbar">
            <div class="swiper-scrollbar-drag">
                <i class="icon-rt-left-arrow left-arrow"></i> Move <i class="icon-rt-right-arrow right-arrow"></i>
            </div>
        </div>
	<?php } ?>
	</div>
