...
class Project extends ElementorBase {
	...
	public function __construct( $data = [], $args = null ) {
		$this->rt_name = esc_html__( 'RT Project', 'nayar-core' );
	...
	protected function register_controls() {
		...
		$this->add_control(
			'layout',
			[
				'label'       => esc_html__( 'Project Layout', 'nayar-core' ),
				'type'        => Controls_Manager::SELECT2,
				'options'   => [
					'layout-1' => esc_html__( 'Project Grid 01', 'nayar-core' ),
					'layout-2' => esc_html__( 'Project Grid 02', 'nayar-core' ),
					'layout-3' => esc_html__( 'Project Grid 03', 'nayar-core' ),
					'layout-4' => esc_html__( 'Project Grid 04', 'nayar-core' ),
					'layout-5' => esc_html__( 'Project Grid 05', 'nayar-core' ),
					'layout-6' => esc_html__( 'Project Grid 06', 'nayar-core' ),
					'layout-7' => esc_html__( 'Project Grid 07', 'nayar-core' ),
					'layout-13' => esc_html__( 'Project Grid 08', 'nayar-core' ),
					'layout-8' => esc_html__( 'Project Slider 01', 'nayar-core' ),
					'layout-9' => esc_html__( 'Project Slider 02', 'nayar-core' ),
					'layout-10' => esc_html__( 'Project Slider 03', 'nayar-core' ),
					'layout-11' => esc_html__( 'Project Slider 04', 'nayar-core' ),
					'layout-12' => esc_html__( 'Project Slider 05', 'nayar-core' ),
				],
				'default'     => 'layout-1',
			]
		);
		...
		$this->add_control(
			'post_limit',
			[
				'label'       => esc_html__( 'Project Limit', 'nayar-core' ),
				'type'        => \Elementor\Controls_Manager::NUMBER,
				'placeholder' => esc_html__( 'Enter Project Limit', 'nayar-core' ),
		...
		$this->add_control(
			...
			[
				...
				'label'       => esc_html__( 'Category Display', 'nayar-core' ),
				'label_on'    => esc_html__( 'On', 'nayar-core' ),
				'label_off'   => esc_html__( 'Off', 'nayar-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Category. Default: On', 'nayar-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label'       => esc_html__( 'Button Display', 'nayar-core' ),
				'label_on'    => esc_html__( 'On', 'nayar-core' ),
				'label_off'   => esc_html__( 'Off', 'nayar-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Button. Default: On', 'nayar-core' ),
			]
		);
		...
		$this->add_control(
			'item_heading',
			[
				'label'     => __( 'Box Item Style', 'nayar-core' ),
		...
		$this->add_control(
			...
			[
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label'       => esc_html__( 'Grayscale Display', 'nayar-core' ),
				'label_on'    => esc_html__( 'On', 'nayar-core' ),
				'label_off'   => esc_html__( 'Off', 'nayar-core' ),
				'return_value' => 'is-blend',
				'description' => esc_html__( 'Show or Hide Image Grayscale. Default: Off', 'nayar-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type'    => Controls_Manager::SELECT,
				'label'   => esc_html__( 'Link Button Option', 'nayar-core' ),
				'description' => esc_html__( 'Display contents details and image popup', 'nayar-core' ),
				'options' => array(
					'default' => esc_html__( 'Default', 'nayar-core' ),
					'popup' => esc_html__( 'Image Popup', 'nayar-core' ),
				),
				'default'     => 'default',
			]
		);
		...
		$this->start_controls_section(
			'sec_category_style',
			[
				'label' => esc_html__( 'Category Style', 'nayar-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'cat_space',
			[
				'label'      => __( 'Category Space', 'nayar-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__('Radius', 'nayar-core'),
				'size_units' => ['px'],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'scrollbar_heading',
			[
				'label'     => __( 'Scrollbar Style', 'nayar-core' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
				'condition'   => [
		...
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'mode'          => 'responsive',
				'label'   => esc_html__( 'Scrollbar UP / Down', 'nayar-core' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Border Color', 'nayar-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Scrollbar Drag Color', 'nayar-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Scrollbar Drag BG Color', 'nayar-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'label_off'   => esc_html__( 'Off', 'nayar-core' ),
				'default'     => 'no',
				'description' => esc_html__( 'Display Pagination. Default: Off', 'nayar-core' ),
			]
		);
		$this->add_control(
			'display_scrollbar',
			[
				'type'        => Controls_Manager::SWITCHER,
				'label'       => esc_html__( 'Scrollbar', 'nayar-core' ),
				'label_on'    => esc_html__( 'On', 'nayar-core' ),
				'label_off'   => esc_html__( 'Off', 'nayar-core' ),
				'default'     => 'no',
				'description' => esc_html__( 'Display Scrollbar. Default: Off', 'nayar-core' ),
			]
		);
		$this->add_control(
			'slides_per_group',
