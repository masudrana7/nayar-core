...
namespace RT\NayarCore\Abstracts;
...
abstract class ElementorWidgetBase extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		$this->nayar_category = NAYAR_CORE_PREFIX . '-widgets'; // Category /@dev
		$this->nayar_icon     = 'rdtheme-el-custom';
	}
	...
	protected function register_controls() {
		...
		foreach ( $fields as $id => $field ) {
			$field['classes'] = ! empty( $field['classes'] ) ? $field['classes'] . ' elementor-control-nayar_el' : ' elementor-control-nayar_el';
		...
		do_action( 'nayar/after/register/controls' );
	}
